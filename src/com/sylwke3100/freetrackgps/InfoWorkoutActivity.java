...
public class InfoWorkoutActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Bundle localBundle = this.getIntent().getExtras();
        if (localBundle != null) {
            ...
            ((TextView) findViewById(R.id.startTimeText))
            ...
            if (localBundle.getString("routeName") != null)
                ((TextView) findViewById(R.id.nameWorkoutTextView))
            ...
            ((TextView) findViewById(R.id.maxHeightText))
                .setText(String.format("%.2f m", maxHeight));
            ((TextView) findViewById(R.id.minHeightText))
